...
class Product:
    ...
    def add_product(self):
        if self.validation():
            ...
            self.message['text'] = 'Producto "{}" Guardado'.format(self.name.get())
            self.name.delete(0, END)
            self.price.delete(0, END)
        else:
            self.message['text'] = 'Ingrese Nombre y Precio'
        self.get_products()
    ...
    def delete_product(self):
        ...
        self.message['text'] = 'Producto "{}" Borrado'.format(name)
        self.get_products()
    ...
    def edit_product(self):
        ...
        try:
            ...
            self.message['text'] = 'Por favor, Seleccione producto'
            return
        name = self.tree.item(self.tree.selection())['text']
        ...
        Button(self.edit_wind, text = 'Modificar', command = lambda: self.edit_records(new_name.get(), name, new_price.get(), old_price)).grid(row = 4, column = 2, sticky = W)
    ...
    def edit_records(self, new_name, name, new_price, old_price):
        ...
        self.message['text'] = 'Producto "{}" Modificado'.format(name)
        self.get_products()
